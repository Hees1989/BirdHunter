...
public abstract class GameObject implements IKeyInput, IMouseInput, PConstants {
	 ...
	 *
	 * @param friction
	 *            the fraction of decrease in speed per cycle of the game loop. Must
	 ...
	 * 
	 * @param object
	 *            GameObject of which you would like to know whether its position
	 ...
	 * 
	 * @param object
	 *            of which you would like to know the distance.
	 * @return distance
	 */
