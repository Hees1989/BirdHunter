 ...
 * 
 * @param <T>
 *            The class this factory will be creating instances of.
 */
public class TileType<T extends Tile> {
	 ...
	 *            The type of class this factory will be creating instances of.
	 * @param sprite
	 *            The image which will be drawn whenever the draw method of the
	 *            created tiles is called.
	 */
	 ...
	 * 
	 * @param tileSize
	 *            the size of the Tile which wil be used to resize the image of the
	 *            Tile.
	 * @return Tile
	 */
