...
public class TileMap {
	 ...
	 * 
	 * @param tileSize
	 *            The size the tiles will be.
	 * @param tileTypes
	 *            The Array with factory's which will be creating the different
	 *            types of tiles.
	 * @param indexMap
	 *            The Map consisting of tileType indexes which will be used to
	 ...
	 * 
	 * @param indexMap
	 *            The two dimensional int array which contains the indexes of the
	 *            tileTypes.
	 */
	 ...
	 * 
	 * @param pGraphics
	 *            The canvas on which the tiles will be drawn.
	 */
	 ...
	 * 
	 * @param x
	 *            The location index of the Tile on the x axis.
	 * @param y
	 *            The location index of the Tile on the y axis.
	 * @param tileType
	 *            The index of the tileType which the tile must become.
	 */
	 ...
	 * 
	 * @param x
	 *            The location in pixels of the Tile on the x axis.
	 * @param y
	 *            The location in pixels of the Tile on the y axis.
	 ...
	 * 
	 * @param tileTypes
	 *            The Array which contains the tileTypes of the tileMap
	 */
	 ...
	 * 
	 * @param tile
	 *            The instance of Tile of which the programmer wants the tileType.
	 ...
	 * 
	 * @param tile
	 *            The instance of Tile of which the programmer wants the Location.
	 * @return An PVector which contains the indexes of the Tile on the x and y axis
	 *         of the tileMap.
	 * @throws TileNotFoundException
	 *             Is being thrown when the given tile is not present in the current
	 *             tileMap.
	 */
