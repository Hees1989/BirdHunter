...
public abstract class FollowingViewport extends Viewport {
	 ...
	 * 
	 * @param top
	 *            The tolerance op the top side the object has to move before the
	 *            Viewport moves with it.
	 * @param bottom
	 *            The tolerance op the bottom side the object has to move before the
	 *            Viewport moves with it.
	 * @param left
	 *            The tolerance op the left side the object has to move before the
	 *            Viewport moves with it.
	 * @param right
	 *            The tolerance op the right side the object has to move before the
	 *            Viewport moves with it.
	 */
