...
public class CenterFollowingViewport extends FollowingViewport {
	 ...
	 *            The height in pixels which the viewPort will cut out of the world.
	 * @param xOffset
	 *            The distance in pixels on the x axis where the center of the
	 *            followed object is from the center of the Viewport
	 * @param yOffset
	 *            The distance in pixels on the y axis where the center of the
	 *            followed object is from the center of the Viewport
	 */
	 ...
	 * 
	 * @param worldGraphics
	 *            The canvas which represents the world from which the viewPort will
	 *            cut its image out of.
